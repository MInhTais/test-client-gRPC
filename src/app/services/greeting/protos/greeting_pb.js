...
goog.exportSymbol('proto.greeting.GetGreetingByIdRequest', null, global)
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.greeting.ReadGreetingsReply.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                greetingsList: jspb.Message.toObjectList(
                    msg.getGreetingsList(),
                    proto.greeting.GreetingReply.toObject,
                    includeInstance
                )
            }
...
proto.greeting.ReadGreetingsReply.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.greeting.GreetingReply.serializeBinaryToWriter)
    }
}
 ...
 * @constructor
 */
proto.greeting.GetGreetingByIdRequest = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null)
}
goog.inherits(proto.greeting.GetGreetingByIdRequest, jspb.Message)
if (goog.DEBUG && !COMPILED) {
    proto.greeting.GetGreetingByIdRequest.displayName = 'proto.greeting.GetGreetingByIdRequest'
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.greeting.GetGreetingByIdRequest.prototype.toObject = function (opt_includeInstance) {
        return proto.greeting.GetGreetingByIdRequest.toObject(opt_includeInstance, this)
    }
     ...
     *     instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.greeting.GetGreetingByIdRequest} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.greeting.GetGreetingByIdRequest.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                id: jspb.Message.getFieldWithDefault(msg, 1, '')
            }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.greeting.GetGreetingByIdRequest}
 */
proto.greeting.GetGreetingByIdRequest.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes)
    var msg = new proto.greeting.GetGreetingByIdRequest()
    return proto.greeting.GetGreetingByIdRequest.deserializeBinaryFromReader(msg, reader)
}

/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.greeting.GetGreetingByIdRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.greeting.GetGreetingByIdRequest}
 */
proto.greeting.GetGreetingByIdRequest.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break
        }
 ...
 * @return {!Uint8Array}
 */
proto.greeting.GetGreetingByIdRequest.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter()
    proto.greeting.GetGreetingByIdRequest.serializeBinaryToWriter(this, writer)
    return writer.getResultBuffer()
}
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.greeting.GetGreetingByIdRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greeting.GetGreetingByIdRequest.serializeBinaryToWriter = function (message, writer) {
    var f = undefined
    f = message.getId()
    if (f.length > 0) {
        writer.writeString(1, f)
 ...
 * @return {string}
 */
proto.greeting.GetGreetingByIdRequest.prototype.getId = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''))
}

/** @param {string} value */
proto.greeting.GetGreetingByIdRequest.prototype.setId = function (value) {
    jspb.Message.setProto3StringField(this, 1, value)
}
